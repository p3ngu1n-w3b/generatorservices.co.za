        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="reveal mt-10 space-y-4" data-reveal-delay="200">
              ...
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-volt/15 text-volt">
                ...
                <div>
                  ...
                  <div className="text-lg font-semibold text-white">{PHONE_DISPLAY}</div>
                </div>
              </a>
              ...
              <div className="card-glass flex items-center gap-4 p-5">
                ...
                <div>
                  ...
                  <div className="text-lg font-semibold text-white">Garden Route &amp; surrounds</div>
                </div>
              </div>
            </div>
          </div>
